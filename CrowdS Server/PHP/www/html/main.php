...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card-2 w3-left-align w3-large">
    ...
    <a href="main.php" class="w3-bar-item w3-button w3-padding-large w3-white">Home</a>
...
<header class="w3-container w3-green w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">CS Project</h1>
  <p class="w3-xlarge">Ville Granfors & Johan Waller</p>
</header>
